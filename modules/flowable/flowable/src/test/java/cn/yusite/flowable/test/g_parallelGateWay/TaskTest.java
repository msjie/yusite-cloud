package cn.yusite.flowable.test.g_parallelGateWay;
...
public class TaskTest {
    ...
    public void startProcessInstance(){
        ...
        System.out.println("流程定义ID:"+pi.getProcessDefinitionId());//流程定义ID   parallelGateWay:1:47504
    }
