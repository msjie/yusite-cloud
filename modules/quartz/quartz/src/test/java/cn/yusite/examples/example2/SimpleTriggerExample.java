...
package cn.yusite.examples.example2;

import static cn.yusite.TestOne.scheduler;
...
public class SimpleTriggerExample {
  ...
  public void run() throws Exception {
    ...
    trigger = newTrigger().withIdentity("trigger7", "group1").startAt(startTime)
        .withSchedule(simpleSchedule().withIntervalInMinutes(2).withRepeatCount(3)).build();
    ...
    trigger = newTrigger().withIdentity("trigger7", "group1").startAt(startTime)
        .withSchedule(simpleSchedule().withIntervalInMinutes(1).withRepeatCount(5)).build();
